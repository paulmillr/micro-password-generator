...
should('Mask generator is reversible', () => {
  ...
  assert.deepStrictEqual('*Tavy-qyjy-vemo-pysu', pwd.mask('@Ss-ss-ss-ss').apply(entropy).password);
  assert.deepStrictEqual('Mavysa-dobywi-nuwem2', pwd.mask('Sss-sss-ssc1').apply(entropy).password);
